...
USteamCoreProUpdateSession* USteamCoreProUpdateSession::UpdateSteamCoreProSession(UObject* WorldContextObject, TMap<FString, FSteamSessionSearchSetting> Settings, FString SessionName, int32 MaxPlayers)
{
	LogVerbose("");
