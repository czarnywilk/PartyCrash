...
#include "SteamProParties.generated.h"
...
*/
UCLASS()
class STEAMCOREPRO_API USteamProParties : public USteamCoreInterface
{
	GENERATED_BODY()
public:
	USteamProParties();
	virtual ~USteamProParties() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "SteamCore")
	static USteamProParties* GetSteamParties();
public:
...
#if WITH_STEAMCORE
	STEAM_CALLBACK_MANUAL(USteamProParties, OnJoinPartyUpdated, JoinPartyCallback_t, OnJoinPartyCallback);
	STEAM_CALLBACK_MANUAL(USteamProParties, OnCreateBeaconUpdated, CreateBeaconCallback_t, OnCreateBeaconCallback);
	STEAM_CALLBACK_MANUAL(USteamProParties, OnReservationNotificationUpdated, ReservationNotificationCallback_t, OnReservationNotificationCallback);
	STEAM_CALLBACK_MANUAL(USteamProParties, OnChangeNumOpenSlotsUpdated, ChangeNumOpenSlotsCallback_t, OnChangeNumOpenSlotsCallback);
	STEAM_CALLBACK_MANUAL(USteamProParties, OnAvailableBeaconLocationsUpdated, AvailableBeaconLocationsUpdated_t, OnAvailableBeaconLocationsCallback);
	STEAM_CALLBACK_MANUAL(USteamProParties, OnActiveBeaconsUpdated, ActiveBeaconsUpdated_t, OnActiveBeaconsCallback);
#endif	
};
