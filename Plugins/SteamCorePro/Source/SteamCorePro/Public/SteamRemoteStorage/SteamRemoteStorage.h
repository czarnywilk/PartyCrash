...
UCLASS()
class STEAMCOREPRO_API USteamProRemoteStorage : public USteamCoreInterface
{
	GENERATED_BODY()
public:
	USteamProRemoteStorage();
	virtual ~USteamProRemoteStorage() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "SteamCore")
	static USteamProRemoteStorage* GetSteamRemoteStorage();
public:
...
#if WITH_STEAMCORE
	STEAM_CALLBACK_MANUAL(USteamProRemoteStorage, OnRemoteStorageUnsubscribePublishedFileResult, RemoteStorageUnsubscribePublishedFileResult_t, OnRemoteStorageUnsubscribePublishedFileResultCallback);
	STEAM_CALLBACK_MANUAL(USteamProRemoteStorage, OnRemoteStorageSubscribePublishedFileResult, RemoteStorageSubscribePublishedFileResult_t, OnRemoteStorageSubscribePublishedFileResultCallback);
	STEAM_CALLBACK_MANUAL(USteamProRemoteStorage, OnRemoteStoragePublishedFileUnsubscribed, RemoteStoragePublishedFileUnsubscribed_t, OnRemoteStoragePublishedFileUnsubscribedCallback);
	STEAM_CALLBACK_MANUAL(USteamProRemoteStorage, OnRemoteStoragePublishedFileSubscribed, RemoteStoragePublishedFileSubscribed_t, OnRemoteStoragePublishedFileSubscribedCallback);
#endif
};
