...
public:
	USteamProNetworking();
	virtual ~USteamProNetworking() override;
...
#if WITH_STEAMCORE
	STEAM_CALLBACK_MANUAL(USteamProNetworking, OnP2PSessionRequest, P2PSessionRequest_t, OnP2PSessionRequestCallback);
	STEAM_CALLBACK_MANUAL(USteamProNetworking, OnP2PSessionConnectFail, P2PSessionConnectFail_t, OnP2PSessionConnectFailCallback);
#endif
};
