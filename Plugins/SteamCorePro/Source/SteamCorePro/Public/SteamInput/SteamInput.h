...
public:
	USteamProInput();
	virtual ~USteamProInput() override;
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SteamCore|Input")
	FString GetGlyphForActionOrigin_Legacy(ESteamCoreProInputActionOrigin Origin);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SteamCore|Input")
	FString GetStringForActionOrigin(ESteamCoreProInputActionOrigin Origin);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SteamCore|Input")
	ESteamCoreProInputActionOrigin GetActionOriginFromXboxOrigin(FInputHandle Handle, ESteamCoreProXboxOrigin Origin);
