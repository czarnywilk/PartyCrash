...
UCLASS()
class STEAMCOREPRO_API USteamProUserStats : public USteamCoreInterface
{
	GENERATED_BODY()
public:
	USteamProUserStats();
	virtual ~USteamProUserStats() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "SteamCore")
	static USteamProUserStats* GetSteamUserStats();
public:
...
#if WITH_STEAMCORE
	STEAM_CALLBACK_MANUAL(USteamProUserStats, OnUserAchievementIconFetched, UserAchievementIconFetched_t, OnUserAchievementIconFetchedCallback);
	STEAM_CALLBACK_MANUAL(USteamProUserStats, OnUserStatsReceived, UserStatsReceived_t, OnUserStatsReceivedCallback);
	STEAM_CALLBACK_MANUAL(USteamProUserStats, OnUserStatsStored, UserStatsStored_t, OnUserStatsStoredCallback);
	STEAM_CALLBACK_MANUAL(USteamProUserStats, OnUserAchievementStored, UserAchievementStored_t, OnUserAchievementStoredCallback);
	STEAM_CALLBACK_MANUAL(USteamProUserStats, OnUserStatsUnloaded, UserStatsUnloaded_t, OnUserStatsUnloadedCallback);
#endif
};
