...
public:
	USteamProApps();
	virtual ~USteamProApps() override;
...
private:
	...
	// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
#if WITH_STEAMCORE
	STEAM_CALLBACK_MANUAL(USteamProApps, OnDLCInstalled, DlcInstalled_t, OnDLCInstalledCallback);
	STEAM_CALLBACK_MANUAL(USteamProApps, OnFileDetailsResult, FileDetailsResult_t, OnOnFileDetailsResultCallback);
#endif
};
