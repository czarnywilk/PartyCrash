...
public:
	...
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", BlueprintInternalUseOnly = "true"), Category = "SteamCore|Matchmaking|Async")
	static USteamCoreProUpdateSession* UpdateSteamCoreProSession(UObject* WorldContextObject, TMap<FString, FSteamSessionSearchSetting> Settings, FString SessionName = "SteamCoreProSession", int32 MaxPlayers = 4);
protected:
