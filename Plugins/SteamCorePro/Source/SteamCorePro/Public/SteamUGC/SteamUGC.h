...
UCLASS()
class STEAMCOREPRO_API USteamProUGC : public USteamCoreInterface
{
	GENERATED_BODY()
public:
	USteamProUGC();
	virtual ~USteamProUGC() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "SteamCore")
	static USteamProUGC* GetSteamUGC();
public:
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamCore|UGC|Delegates")
	FOnWorkshopEULAStatus WorkshopEULAStatus;
...
public:
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "SteamCore|UGC")
	static bool AddContentDescriptor(FUGCUpdateHandle Handle, ESteamUGCContentDescriptorID DescId);
	
	UFUNCTION(BlueprintCallable, Category = "SteamCore|UGC")
	static bool RemoveContentDescriptor(FUGCUpdateHandle Handle, ESteamUGCContentDescriptorID DescId);
	...
	*/
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SteamCore|UGC")
	void GetWorkshopEULAStatus(const FOnGetWorkshopEULAStatus& Callback);
...
#if WITH_STEAMCORE
	STEAM_CALLBACK_MANUAL(USteamProUGC, OnDownloadItemResult, DownloadItemResult_t, OnDownloadItemResultCallback);
	STEAM_CALLBACK_MANUAL(USteamProUGC, OnItemInstalled, ItemInstalled_t, OnItemInstalledCallback);
	STEAM_CALLBACK_MANUAL(USteamProUGC, OnUserSubscribedItemsListChanged, UserSubscribedItemsListChanged_t, OnUserSubscribedItemsListChangedCallback);
	STEAM_CALLBACK_MANUAL(USteamProUGC, OnWorkshopEULAStatus, WorkshopEULAStatus_t, OnWorkshopEULAStatusCallback);
#endif
};
